...
今年早些时候在Apple实习的时候我想做一个NLP side project 来着，主要概念是用DL模型去聚合提取更加重要的新闻,比如对同一事件的不同视角去做各自的分析。然后我陆续意识到了几个问题，一是当时就意识到的用网络的力量来筛选是最有效的，单机的模型和网络过滤相比完全肯定被碾压。ML模型的应用最重要的就是找到业务和数据的闭环。而我这样一个self host的side project完全想象不出合理的闭环逻辑。另外一个这个几乎就是一个舆情监测系统，难道我自己的side project就是low到做这种我自己不屑为之的极权工具吗？ 另外一个是我最近意识到的，现在的时代是高质量的内容都在付费墙后，而谎言和阴谋论内容则是到处免费分发。从garbage in garbage out的角度来看这个项目也是几乎不可行的。



# 简明文革史线索

我看了571工程纪要之后发现，这里面着重论述的极权的问题其实今天已经又一次回来了这一页。571里面林彪和秦始皇必有一死的局面，必然也再今日重现。这是威权体制下必然发生的。由此571工程纪要有了更多的当下的价值。
...
https://theinitium.com/article/20200103-mainland--economic-data-consumption/

聯繫這個系列談談我對中國經濟的看法和預測

https://theinitium.com/article/20191219-mainland-economic-data-manufacturing-industry/

我覺得這篇探討的就是乾爹說的中國是否因爲大力推廣機器人和智能革命導致過早工業化進入中等收入陷阱的問題
...
202003: 在疫情期间老蛮从头到尾力挺复工和没事的发言就很明显体现了他是带着任务的身份。这也解释了他之前为何能活那么久。他就是属于党内另一派
